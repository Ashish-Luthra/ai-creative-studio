    ...
    const socialIcons = [
      {
        ...
        title: 'Facebook',
        svg: (
          <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="h-5 w-5">
      ...
      },
      {
        ...
        title: 'Instagram',
        svg: (
          <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="h-5 w-5">
            <path d="m373.406 0h-234.812c-76.422 0-138.594 62.172-138.594 138.594v234.816c0 76.418 62.172 138.59 138.594 138.59h234.816c76.418 0 138.59-62.172 138.59-138.59v-234.816c0-76.422-62.172-138.594-138.594-138.594zm108.578 373.41c0 59.867-48.707 108.574-108.578 108.574h-234.812c-59.871 0-108.578-48.707-108.578-108.574v-234.816c0-59.871 48.707-108.578 108.578-108.578h234.816c59.867 0 108.574 48.707 108.574 108.578z"/>
            <path d="m256 116.004c-77.195 0-139.996 62.8-139.996 139.996s62.8 139.996 139.996 139.996 139.996-62.8 139.996-139.996-62.8-139.996-139.996-139.996zm0 249.977c-60.641 0-109.98-49.336-109.98-109.981 0-60.64 49.34-109.98 109.98-109.98 60.645 0 109.98 49.34 109.98 109.98 0 60.645-49.335 109.981-109.98 109.981z"/>
            <path d="m399.344 66.285c-22.813 0-41.367 18.559-41.367 41.367 0 22.813 18.554 41.371 41.367 41.371s41.371-18.558 41.371-41.371-18.558-41.367-41.371-41.367zm0 52.719c-6.258 0-11.351-5.094-11.351-11.352 0-6.261 5.093-11.351 11.351-11.351 6.262 0 11.355 5.09 11.355 11.351 0 6.258-5.093 11.352-11.355 11.352z"/>
          </svg>
        ),
      },
      {
        ...
        title: 'Pinterest',
        svg: (
          <svg viewBox="0 0 511.977 511.977" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="h-5 w-5">
      ...
      },
      {
        ...
        title: 'X (Twitter)',
        svg: (
          <svg viewBox="0 0 1226.37 1226.37" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="h-5 w-5">
