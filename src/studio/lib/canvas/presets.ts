...
export const CREATIVE_PRESETS: CreativePreset[] = [
  ...
  { id: 'youtube-thumb-16-9', label: 'YouTube 16:9', platform: 'youtube', ratioLabel: '16:9', width: 1280, height: 720 },
  { id: 'youtube-short-9-16', label: 'YouTube Short 9:16', platform: 'youtube', ratioLabel: '9:16', width: 1080, height: 1920 },
]
