...
export interface AgentPillProps {
  ...
  placeholder?: string
  className?: string
  /** Locks the pill while the agent is working. */
  disabled?: boolean
}
...
export const AgentPill: React.FC<AgentPillProps> = ({
  ...
  // The ⌘K affordance below was decorative for a long time — wire it up so the
  ...
  return (
    ...
    >
      ...
      <input
        ...
        disabled={disabled}
        className="flex-1 bg-transparent text-[13px] text-gray-900 placeholder:text-gray-400 outline-none disabled:cursor-not-allowed disabled:text-gray-400"
      />
